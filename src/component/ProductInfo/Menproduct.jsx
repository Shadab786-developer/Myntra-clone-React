// This file is a React component for displaying men's products in the Myntra clone.
...
function Menproduct() {
  ...
  const renderComponent = (item, index) => (
    <>
      <div className="w-64 m-4 " key={index}>
        ...
        <div className="text-gray-300 text-[14px] mb-0 mt-0 whitespace-nowrap font-normal block">
          {item.item_name}
        </div>
  ...
  // Filter items to only include men's products
  const filterMenItem = items.filter((item) => item.item_type === "men");
    ...
    sm:mb-[5%]"
            ...
            <div className="w-3/4 p-4">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-semibold">Shirts For Men</h2>
