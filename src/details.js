...
const items = [
  ...
  },
  {
    id: crypto.randomUUID(), // Unique identifier for the item
    item_image:
      "https://assets.myntassets.com/f_webp,dpr_1.5,q_60,w_210,c_limit,fl_progressive/assets/images/32148183/2024/12/30/fcc006eb-3454-4245-ae76-3f0975087a9d1735567291414ColorfulButterflyMotivationalPositiveWallQuotesStickers30CMx1.jpg",
    item_type: "home&living",
    rating: {
      stars: 4.3,
      noOfReviews: 589,
    },
    quantity: 1,
    company_name: "Jaamso Royals",
    item_name: "Printed Self Adhesive Stickers",
    current_price: 789,
    original_price: 2000,
    discount_percentage: 60,
    return_period: 8,
    delivery_date: "29th feb",
  },
  {
    id: crypto.randomUUID(), // Unique identifier for the item
    item_image:
